...
Untuk menjadikan skypie sebagai fixed ip, pertama-tama pastikan ip `dhcp.conf` sudah benar. Setelah itu masukan kode dibawah, hardware ethernet didapatkan dengan melihat output dari kode dibawah
...
Buatlah super.franky.e03.com pada dns server
...
Config dari `/etc/bind/jarkom/super.franky.e03.com`
...
Config webserver pada super.franky.e03.com pada sites-available
...
```
setelah itu masukan command `a2ensite super.franky.e03.com.conf` pada sites-available


Lalu pada setting server squid lakukanlah config seperti dibawah
```
...
Maka otomatis jika mengkases google.com akan redirect pada website `super.frank.e03.com`
